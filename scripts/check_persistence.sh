...
PROJECT_DIR="${PROJECT_DIR:-${WORKSPACE}/VIRCHOW2}"
RCLONE_CONF="${HOME:-/root}/.config/rclone/rclone.conf"
VENV_DIR="${WORKSPACE}/VIRCHOW2/venv"
MODEL_DIR="${WORKSPACE}/VIRCHOW2/models/virchow2"
...
for module_name in ["fastapi", "uvicorn", "httpx", "timm", "huggingface_hub", "transformers"]:
    try:
