"""
Contract validation: Laravel ↔ RunPod end-to-end (Virchow2 edition).
...
from app.server import JobStartRequest  # noqa: E402
...
# Mirror buildPayload() in FeatureExtractionJob.php (adapted for Virchow2)
fake_sample = {
    "id": 42,
...
fake_mag = "20x"
fake_model = {
    "id": 2, "name": "Virchow2", "huggingface": "paige-ai/Virchow2",
    "version": "v2.0", "embedding_dim": "1280", "input_resolution": "224",
}
...
check("ai_model.slug present",   parsed.ai_model.slug == "virchow2")
...
check("seg[2] = AI model name",  parts[2] == "Virchow2")
...
# Build payloads exactly as APIClient methods do (adapted for Virchow2)
report_started_payload = {
    ...
    "model_name": "Virchow2", "model_version": "", "error_message": "",
}
report_completed_payload = {
    ...
    "model_name": "Virchow2", "model_version": "v2.0", "error_message": "",
}
report_failed_payload = {
    ...
    "runpod_output_path": "", "features_gdrive_path": "", "features_gdrive_folder_id": "",
    "patch_count": 0, "failed_patch_count": 0,
    "model_name": "Virchow2", "model_version": "", "error_message": "Test failure mode.",
}
